...
const AiEvaluationSchema = new mongoose_1.Schema({
    teamId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Team', required: true, unique: true },
    scores: {
...
exports.default = mongoose_1.default.model('AiEvaluation', AiEvaluationSchema);
//# sourceMappingURL=AiEvaluation.js.map